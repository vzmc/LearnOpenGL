...
//	// -------------------------
//	Shader reflectShader("reflect.vert", "refract.frag");
...
//	Model ball = Model(FileSystem::getPath("soccer/untitled.fbx"));
//
...
//		glm::mat4 view_without_transform = glm::mat4(glm::mat3(view));
...
//
//		reflectShader.setMat4("model", model);
//		ball.Draw(reflectShader);
//		//aquaModel.Draw(reflectShader);
//
//		//// floor
//		//shader.use();
...
//		skyboxShader.setMat4("view", view_without_transform);
//		glBindVertexArray(skyboxVAO);
//		glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTexture);
//		glDrawArrays(GL_TRIANGLES, 0, 36);
//		glDepthFunc(GL_LESS);
