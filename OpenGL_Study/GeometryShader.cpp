...
//	Shader explodeShader("explode_model.vert", "explode_model.frag"); // , "explode_model.geom");
//	Shader showNormalShader("show_normal.vert", "show_normal.frag", "show_normal.geom");
//
//	//float cubeVertices[] = {
//	//	// Back face
...
//	unsigned int uniformBlockIndexExplode = glGetUniformBlockIndex(explodeShader.ID, "Matrices");
//	unsigned int uniformBlockIndexShowNormal = glGetUniformBlockIndex(showNormalShader.ID, "Matrices");
//
//	// 然后将他们block连接到绑定位置
...
//	glUniformBlockBinding(explodeShader.ID, uniformBlockIndexExplode, 0);
//	glUniformBlockBinding(showNormalShader.ID, uniformBlockIndexShowNormal, 0);
//
//	// 生成实际的buffer
...
//		aquaModel.Draw(explodeShader);
//
//		showNormalShader.use();
//		showNormalShader.setMat4("model", model);
//		aquaModel.Draw(showNormalShader);
//
//		// skybox
